            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        <a href="Seller_index.php" class="nav-item nav-link active">Home</a>
                        <a href="Seller_products_uploaded.php" class="nav-item nav-link">Products</a>
                        <a href="Seller_product.php" class="nav-item nav-link">Sell Product</a>
                        <a href="Seller_product_order_lists.php" class="nav-item nav-link">Product Orders</a>
                        <a href="Seller_order_status.php" class="nav-item nav-link">Delivery Details</a>
                        <a href="Seller_analytics.php" class="nav-item nav-link">Data Analytics</a>
                    </div>
